...
router.put('/update-factory-detail', dashboardController.updateFactoryDetail_put);
router.delete('/delete-factory-detail', dashboardController.deleteFactoryDetail_delete);
